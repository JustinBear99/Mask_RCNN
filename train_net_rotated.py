...
def main(args):
    ...
    register_coco_instances('asparagus_val_rotated', {'_background_': 0, 'clump': 1, 'stalk': 2, 'spear': 3, 'bar': 4} , "./datasets/coco/annotations/val_rotated_637/annotations.json", "./datasets/coco/annotations/val_rotated_637")
